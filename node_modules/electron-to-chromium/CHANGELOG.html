...
<html lang="en">
  <head>
    ...
    <title>
      v1.3.0 * Additionally include chromium to electron mappingsv1.2.0 *
      versions and full-versions are now separately importable.v1.1.0 * Both
      electronToChrom...
    </title>
    <meta
      name="description"
      content="v1.3.0  * Additionally include chromium to electron mappingsv1.2.0  * versions and full-versions are now separately importable.v1.1.0  * Both electronToChrom..."
    />
    ...
    <link
      rel="canonical"
      href="https://sup.datashaman.com/pages/datashaman/sup.datashaman.com/node_modules/electron-to-chromium/CHANGELOG.html"
    />
    <link
      rel="alternate"
    ...
    <div class="container md:mx-auto p-4 md:flex">
      ...
      <section class="flex-grow md:px-4">
        <article class="bg-white p-4 mb-4 rounded shadow">
          <a href="/node_modules/electron-to-chromium/CHANGELOG.html"
            ><h2></h2
          ></a>
          <hr />
          <p>v1.3.0</p>
          ...
          <ul>
            <li>
              Both electronToChromium and electronToBrowserList now can accept
              strings as well as numbers.
            </li>
          </ul>

          <p>v1.0.1 Update documentation</p>

          <p>v1.0.0 Inititial release</p>
        </article>
      </section>
    </div>
