...
<html lang="en">
  <head>
    ...
    <link
      rel="canonical"
      href="https://sup.datashaman.com/pages/datashaman/sup.datashaman.com/node_modules/postcss/docs/guidelines/plugin.html"
    />
    <link
      rel="alternate"
    ...
    <div class="container md:mx-auto p-4 md:flex">
      ...
      <section class="flex-grow md:px-4">
        <article class="bg-white p-4 mb-4 rounded shadow">
          <a href="/node_modules/postcss/docs/guidelines/plugin.html"
          ...
          <p>
            ...
            PostCSS — for example, <a href="https://rtlcss.com/">RTLCSS</a> and
          ...
          <p>
            For example,
            <a href="https://preset-env.cssdb.org/"
              ><code class="highlighter-rouge">postcss-preset-env</code></a
            >
            contains many small plugins, one for each W3C specification. And
            <a href="https://github.com/ben-eb/cssnano"
          ...
          <p>
            ...
            <a href="https://github.com/postcss/postcss-mixins"
              ><code class="highlighter-rouge">postcss-mixins</code></a
            >.
          </p>
          ...
          <div class="language-js highlighter-rouge">
            <div class="highlight">
              <pre
                class="highlight"
              ><code><span class="nx">module</span><span class="p">.</span><span class="nx">exports</span> <span class="o">=</span> <span class="nx">postcss</span><span class="p">.</span><span class="nx">plugin</span><span class="p">(</span><span class="dl">'</span><span class="s1">plugin-name</span><span class="dl">'</span><span class="p">,</span> <span class="nx">opts</span> <span class="o">=&gt;</span> <span class="p">{</span>
...
<span class="p">})</span>
          ...
          <div class="language-js highlighter-rouge">
            <div class="highlight">
              <pre
                class="highlight"
              ><code><span class="nx">postcss</span><span class="p">.</span><span class="nx">plugin</span><span class="p">(</span><span class="dl">'</span><span class="s1">plugin-sprite</span><span class="dl">'</span><span class="p">,</span> <span class="nx">opts</span> <span class="o">=&gt;</span> <span class="p">{</span>
  <span class="k">return</span> <span class="p">(</span><span class="nx">root</span><span class="p">,</span> <span class="nx">result</span><span class="p">)</span> <span class="o">=&gt;</span> <span class="p">{</span>
...
<span class="p">})</span>
          ...
          <p>
            So if you add a new declaration based on some existing declaration,
          ...
          <div class="language-js highlighter-rouge">
            <div class="highlight">
              <pre
                class="highlight"
              ><code><span class="k">if</span> <span class="p">(</span><span class="nx">needPrefix</span><span class="p">(</span><span class="nx">decl</span><span class="p">.</span><span class="nx">prop</span><span class="p">))</span> <span class="p">{</span>
...
<span class="p">}</span>
          ...
          <div class="language-js highlighter-rouge">
            <div class="highlight">
              <pre
                class="highlight"
              ><code><span class="k">if</span> <span class="p">(</span><span class="nx">outdated</span><span class="p">(</span><span class="nx">decl</span><span class="p">.</span><span class="nx">prop</span><span class="p">))</span> <span class="p">{</span>
...
<span class="p">}</span>
          ...
          <p>
            ...
            <code class="highlighter-rouge">README.md</code> wrote in English.
