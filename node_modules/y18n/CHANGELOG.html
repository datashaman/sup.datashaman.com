...
<html lang="en">
  <head>
    ...
    <title>
      # Change LogAll notable changes to this project will be documented in this
      file. See
      [standard-version](https://github.com/conventional-changelog/standard-ve...
    </title>
    <meta
      name="description"
      content="# Change LogAll notable changes to this project will be documented in this file. See [standard-version](https://github.com/conventional-changelog/standard-ve..."
    />
    ...
    <link
      rel="canonical"
      href="https://sup.datashaman.com/pages/datashaman/sup.datashaman.com/node_modules/y18n/CHANGELOG.html"
    />
    <link
      rel="alternate"
    ...
    <div class="container md:mx-auto p-4 md:flex">
      ...
      <section class="flex-grow md:px-4">
        <article class="bg-white p-4 mb-4 rounded shadow">
          <a href="/node_modules/y18n/CHANGELOG.html"><h2>Change Log</h2></a>
          <hr />
          ...
          <p><a name="4.0.0"></a></p>
          <h1 id="400-2017-10-10">
            <a href="https://github.com/yargs/y18n/compare/v3.2.1...v4.0.0"
              >4.0.0</a
            >
            (2017-10-10)
          </h1>
          ...
          <ul>
            <li>
              allow support for falsy values like 0 in tagged literal (<a
                href="https://github.com/yargs/y18n/issues/45"
                >#45</a
              >) (<a href="https://github.com/yargs/y18n/commit/c926123"
                >c926123</a
              >)
            </li>
          </ul>
          ...
          <ul>
            <li>
              <strong>__:</strong> added tagged template literal support (<a
                href="https://github.com/yargs/y18n/issues/44"
                >#44</a
              >) (<a href="https://github.com/yargs/y18n/commit/0598daf"
                >0598daf</a
              >)
            </li>
          </ul>
