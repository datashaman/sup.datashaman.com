...
<html lang="en">
  <head>
    ...
    <title>
      ...
      least Node 4.* Breaking: Update PostCSS to 6.0.0.# 0.1.1* Add
      transpilation.# 0.1.0* F...
    </title>
    <meta
      name="description"
      content="# 4.0.0-rc.0* Breaking: Drops support for Node 0.12, we now require at least Node 4.* Breaking: Update PostCSS to 6.0.0.# 0.1.1* Add transpilation.# 0.1.0* F..."
    />
    ...
    <link
      rel="canonical"
      href="https://sup.datashaman.com/pages/datashaman/sup.datashaman.com/node_modules/postcss-discard-overridden/CHANGELOG.html"
    />
    <link
      rel="alternate"
    ...
    <div class="container md:mx-auto p-4 md:flex">
      ...
      <section class="flex-grow md:px-4">
        <article class="bg-white p-4 mb-4 rounded shadow">
          <a href="/node_modules/postcss-discard-overridden/CHANGELOG.html"
            ><h2>4.0.0-rc.0</h2></a
          >
          <hr />
