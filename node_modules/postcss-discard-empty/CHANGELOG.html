...
<html lang="en">
  <head>
    ...
    <title>
      ...
      least Node 4.* Breaking: Update PostCSS to 6.0.0.# 2.1.0*
      postcss-discard-empty will n...
    </title>
    <meta
      name="description"
      content="# 4.0.0-rc.0* Breaking: Drops support for Node 0.12, we now require at least Node 4.* Breaking: Update PostCSS to 6.0.0.# 2.1.0* postcss-discard-empty will n..."
    />
    ...
    <link
      rel="canonical"
      href="https://sup.datashaman.com/pages/datashaman/sup.datashaman.com/node_modules/postcss-discard-empty/CHANGELOG.html"
    />
    <link
      rel="alternate"
    ...
    <div class="container md:mx-auto p-4 md:flex">
      ...
      <section class="flex-grow md:px-4">
        <article class="bg-white p-4 mb-4 rounded shadow">
          <a href="/node_modules/postcss-discard-empty/CHANGELOG.html"
            ><h2>4.0.0-rc.0</h2></a
          >
          <hr />
          ...
          <ul>
            <li>
              ...
              <code class="highlighter-rouge">4.1</code> plugin API.
            </li>
          </ul>
