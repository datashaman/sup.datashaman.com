...
<html lang="en">
  <head>
    ...
    <title>
      # 4.0.0-rc.0* Initial commit. This module was previously part of other
      cssnano modules and has been extracted out.
    </title>
    <meta
      name="description"
      content="# 4.0.0-rc.0* Initial commit. This module was previously part of other cssnano modules and  has been extracted out."
    />
    ...
    <link
      rel="canonical"
      href="https://sup.datashaman.com/pages/datashaman/sup.datashaman.com/node_modules/cssnano-util-get-arguments/CHANGELOG.html"
    />
    <link
      rel="alternate"
    ...
    <div class="container md:mx-auto p-4 md:flex">
      ...
      <section class="flex-grow md:px-4">
        <article class="bg-white p-4 mb-4 rounded shadow">
          <a href="/node_modules/cssnano-util-get-arguments/CHANGELOG.html"
            ><h2>4.0.0-rc.0</h2></a
          >
          <hr />
          ...
          <ul>
            <li>
              Initial commit. This module was previously part of other cssnano
              modules and has been extracted out.
            </li>
          </ul>
        </article>
      </section>
