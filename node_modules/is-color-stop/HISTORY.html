...
<html lang="en">
  <head>
    ...
    <title># is-color-stop## 1.0.0- bump## 1.1.0- support calc</title>
    <meta
      name="description"
      content="# is-color-stop## 1.0.0- bump## 1.1.0- support calc"
    />
    ...
    <link
      rel="canonical"
      href="https://sup.datashaman.com/pages/datashaman/sup.datashaman.com/node_modules/is-color-stop/HISTORY.html"
    />
    <link
      rel="alternate"
    ...
    <div class="container md:mx-auto p-4 md:flex">
      ...
      <section class="flex-grow md:px-4">
        <article class="bg-white p-4 mb-4 rounded shadow">
          <a href="/node_modules/is-color-stop/HISTORY.html"
            ><h2>is-color-stop</h2></a
          >
          <hr />
          <h1 id="is-color-stop">is-color-stop</h1>
